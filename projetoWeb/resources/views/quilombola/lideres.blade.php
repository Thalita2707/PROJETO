    ...
    <main>
        <section class="topico-inicial">
            ...
            <div class="d-flex align-items-start gap-3">
                <img src="imagem/prinlid.jpg" alt="Imagem primaria" class="img-fluid" style="max-width: 300px;">
                <div>
        ...
        <section class="Ganga">
            ...
            <div class="d-flex align-items-center gap-3">
                <img src="imagem/ganga.jpg" alt="Imagem Ganga" class="img-fluid" style="max-width: 200px;">
        ...
        <section class="Zumbi">
            ...
            <div class="d-flex align-items-center gap-3">
                <img src="imagem/zumbi.jpg" alt="Imagem representando Zumbi" class="img-fluid" style="max-width: 200px;">
        ...
        <section class="Dandara">
            ...
            <div class="d-flex align-items-center gap-3">
                <img src="imagem/dandara.jpg" alt="Imagem Dandara" class="img-fluid" style="max-width: 200px;">
